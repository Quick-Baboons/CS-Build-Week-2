...
from thesecrets import requests_blaine, BLAINE_TOKEN, API_URL
...
blaine = Player("Matt", str(player_data['room_id']), requests_blaine)
...
# Mine coins 4 evar ⛏
while True:
    make_it_rain(blaine, BLAINE_TOKEN, g)
